 ...
 * {@link LecturerConsultationDetails.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link LecturerConsultationDetails#newInstance} factory method to
 * create an instance of this fragment.
 */
public class LecturerConsultationDetails extends Fragment {
    ...
    public LecturerConsultationDetails() {
     ...
     * @return A new instance of fragment LecturerConsultationDetails.
     */
    // TODO: Rename and change types and number of parameters
    public static LecturerConsultationDetails newInstance(String param1, String param2) {
        LecturerConsultationDetails fragment = new LecturerConsultationDetails();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View RootView=inflater.inflate(R.layout.fragment_lecturer_consultation_details, container, false);
                        ...
                        if (task.isSuccessful()) {
                            ...
                            for (QueryDocumentSnapshot document : task.getResult()) {
                                if(document.getString("lecturer").equals(userName) &&
                                    ...
                                    final String stID=document.getString("student");
                                    ...
                                    db.collection("users")
                                            ...
                                            .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                                                ...
                                                public void onComplete(@NonNull Task<QuerySnapshot> task) {
                                                    if (task.isSuccessful()) {
                                                        for (QueryDocumentSnapshot document : task.getResult()) {
                                                            if(document.getString("username").toString().equals(stID)) {
                ...
                db.collection("cons").document(docId).set(data, SetOptions.merge())
                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void aVoid) {
                                ...
                                Class fragmentClass = LecurerConsultationList.class;
        ...
        bSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Map<String, Object> data = new HashMap<>();
                String feed=eLectFeed.getText().toString();
                data.put("lf",feed);
                db.collection("cons").document(docId).set(data, SetOptions.merge())
                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                            @Override
