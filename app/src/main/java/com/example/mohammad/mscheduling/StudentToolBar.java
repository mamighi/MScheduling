...
public class StudentToolBar extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener,
        BookConsultatio.OnFragmentInteractionListener,
        BookConsultaionFinal.OnFragmentInteractionListener,
        StudentConsultaionList.OnFragmentInteractionListener,
        StudentConsDetail.OnFragmentInteractionListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_student_tool_bar);
        ...
        fragmentClass = StudentConsultaionList.class;
        try {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        //getMenuInflater().inflate(R.menu.student_tool_bar, menu);
        return true;
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_list) {
            ...
            fragmentClass = BookConsultatio.class;

        } else if (id == R.id.nav_leList) {
